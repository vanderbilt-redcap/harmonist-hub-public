...
class Model
{
    ...
    public function __construct(HarmonistHubPublicExternalModule $module, $projectId, $defaultValues = null)
    {
        $this->module = $module;
    ...
    public function fetchSurveyLink($projectId, $recordId, $surveyName,$instance = 1):string
    {
