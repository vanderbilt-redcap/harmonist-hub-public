...
if($option == "0"){
    ...
    $button = '<button onclick="follow_activity(\'1\',\''.$userid.'\',\''.$request_id.'\',\''.$module->getUrl('hub/hub_request_follow_activity_AJAX.php', true).'\',\'' . $module->getCSRFToken() . '\')" class="btn btn-secondary actionbutton"><i class="fa fa-plus-square"></i> <span class="d-none d-sm-inline">Follow Activity</span></button>';
}else if($option == "1"){
    #FOLLOW
    if($follow_activity == ''){
    ...
    $button = '<button onclick="follow_activity(\'0\',\''.$userid.'\',\''.$request_id.'\',\''.$module->getUrl('hub/hub_request_follow_activity_AJAX.php', true).'\',\'' . $module->getCSRFToken() . '\')" class="btn btn-primary actionbutton"><i class="fa fa-check-square"></i> <span class="d-none d-sm-inline">Following</span></button>';
}
